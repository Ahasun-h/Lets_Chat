...
import com.example.letschat.activity.MessageActivity;
...
public class ChatingAdapter extends RecyclerView.Adapter<ChatingAdapter.ViewHolder> {
    ...
    public ChatingAdapter (Context mContext, List<User> mUsers,boolean ischat){
        this.mUsers = mUsers;
    ...
    public ChatingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ChatingAdapter.ViewHolder( view );
    }

    @Override
    public void onBindViewHolder(@NonNull ChatingAdapter.ViewHolder holder, int position) {
